...
check_request_list_of_recent_requests_template = PromptTemplate(
    template="Analyze the {input} and based on the content if the request does not exist, you can quote that the can select from a list recent purchase requests. Don't display the list here. request the user to kindly select input the ID of the purchase request you want to assign."
)
